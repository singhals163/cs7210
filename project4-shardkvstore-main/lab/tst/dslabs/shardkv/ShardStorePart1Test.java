...
public final class ShardStorePart1Test extends ShardStoreBaseTest {
    @Test(timeout = 5 * 1000)
    @TestDescription("Single group, basic workload - single server")
    @Category(RunTests.class)
    @TestPointValue(10)
    public void test01BasicSingleServer() throws InterruptedException {
    ...
    @TestDescription("Multi-group join/leave - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    public void test02JoinLeaveSingleServer() throws InterruptedException {
    ...
    @TestDescription("Shards move when group joins - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    public void test03ShardsMoveOnJoinSingleServer() throws InterruptedException {
    ...
    @Test(timeout = 25 * 1000)
    @TestDescription("Shards move when moved by ShardMaster - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    public void test04ShardsMoveOnMoveSingleServer() throws InterruptedException {
        int numServersPerGroup = 1, numShardMasters = 1, numShards = 100;
    ...
    @TestDescription("Repeated shard movement - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    public void test05ConstantMovementSingleServer() throws InterruptedException {
    ...
    @TestPointValue(15)
    public void test06JoinLeaveUnreliableSingleServer() throws InterruptedException {
        runSettings.networkDeliverRate(0.8);
        test02JoinLeaveSingleServer();
    }
    ...
    @Category({RunTests.class, UnreliableTests.class})
    @TestPointValue(30)
    public void test07ConstantMovementUnreliableSingleServer() throws InterruptedException {
        runSettings.networkDeliverRate(0.8);
        test05ConstantMovementSingleServer();
    }
