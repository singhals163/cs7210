...
public abstract class ShardStoreBaseTest extends BaseJUnitTest {
  ...
  protected void setupStates(int numGroups, int numServersPerGroup, int numShardMasters, int numShards) {
  ...
  protected void joinGroup(int groupNum, int numServersPerGroup) throws InterruptedException {
    sendCommandAndCheck(
        configController, new Join(groupNum, servers(groupNum, numServersPerGroup)), new Ok());
  }

  protected void removeGroup(int groupNum) throws InterruptedException {
  ...
  protected void assertConfigBalanced() throws InterruptedException {
  ...
  protected Runnable moveShards(int numGroups, int numShards) {
    return () -> {
