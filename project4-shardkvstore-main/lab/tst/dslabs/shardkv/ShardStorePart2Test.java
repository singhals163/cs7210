...
public final class ShardStorePart2Test extends ShardStoreBaseTest {
    @Test(timeout = 5 * 1000)
    ...
    @TestPointValue(20)
    public void test10MultiServerRandomSearch() {
        int numServersPerGroup = 3;
