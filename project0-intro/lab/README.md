...
```
$ ./run-tests.py --lab 0 --test-num 1.1
...
```
$ ./run-tests.py --lab 0 --test-num 1.1 --log-level FINEST
...
```
$ ./run-tests.py --lab 0 --test-num 1.3
...
```
$ ./run-tests.py --lab 0 --test-num 1.4
...
```
$ ./run-tests.py --lab 0 --test-num 1.4 --start-viz
```
...
![State Graph](./pic/state-graph.png)
